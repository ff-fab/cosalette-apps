...
| ------------------------------------ | ---------------------------------- | ------ | --- |
| `gas2mqtt/_meta/registry`            | Canonical AsyncAPI 3.0.0 document   | yes    | 1   |
| `gas2mqtt/_meta/state_model_drift`   | `state_model` drift snapshot JSON   | yes    | 1   |

### Registry (`gas2mqtt/_meta/registry`)

The canonical AsyncAPI document describing every channel gas2mqtt publishes and
