...
- Added: `__aenter__`/`__aexit__` on `Qmc5883lAdapter`, `FakeMagnetometer`,
  `MagnetometerPort`

**Tests created/changed:**

- Replaced `TestLifespan` (3 tests) with `TestAdapterLifecycle` (3 tests) in
  test_app_wiring.py
- All 106 unit tests + 10 integration tests passing

**Review Status:** APPROVED

**Git Commit Message:** feat: adopt cosalette 0.1.5 adapter lifecycle and settings DI

- Add **aenter**/**aexit** to Qmc5883lAdapter and FakeMagnetometer
