...
| Protocol version   | `CALDATES2MQTT_MQTT__PROTOCOL_VERSION` | `3.1.1` | `5` enables retained-message expiry (compose default), see below |
| Message expiry     | `CALDATES2MQTT_MQTT__MESSAGE_EXPIRY_INTERVAL` | `86400` | Expiry of retained messages in seconds (MQTT 5 only) |
...
| Setting         | Env Variable                          | Default                          | Description                                                  |
| --------------- | ------------------------------------- | -------------------------------- | ------------------------------------------------------------ |
| Protocol        | `CALDATES2MQTT_MQTT__PROTOCOL_VERSION`         | `3.1.1` in code, `5` in compose  | `5` enables expiry and refresh, `3.1.1` disables both        |
| Expiry interval | `CALDATES2MQTT_MQTT__MESSAGE_EXPIRY_INTERVAL`  | `86400`                          | Seconds, at least `3`; valid only with protocol `5`          |
