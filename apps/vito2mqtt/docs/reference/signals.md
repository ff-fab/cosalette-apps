...
### Registry (`vito2mqtt/_meta/registry`)

The canonical AsyncAPI document describing every channel vito2mqtt publishes and
...
### State Model Drift (`vito2mqtt/_meta/state_model_drift`)
