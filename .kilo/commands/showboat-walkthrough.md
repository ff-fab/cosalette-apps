...
<!-- mirrors .github/prompts/showboat-walkthrough.prompt.md — keep description in sync -->
...
All `exec` blocks must produce the same output on re-run. If verification fails, fix the
failing block (`showboat pop` + re-add).
