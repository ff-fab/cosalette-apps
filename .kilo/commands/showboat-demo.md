---
description:
  Create a showboat demo that proves the current branch work. Analyzes the diff and
  builds a reproducible proof-of-work document.
agent: implement
model: opencode-go/deepseek-v4-pro
subtask: false
---

<!-- mirrors .github/prompts/showboat-demo.prompt.md — keep description in sync -->
